function [mu_berg,lam_berg,f] = bst_berg_cjb(R,sigma,nmax,J,mu_berg_init,lam_berg_init)
...
[berg_out,fval,outputs]=...
    fminsearch(@zhang_fit_local,[mu_berg_init lam_berg_init(2:J)],OPTIONS,R,f); 
